export const template = `
    ...
    <div class="profile_main">
        <div class="profile">
            ...
            <form class="profile-form" id="profile-password">
                ...
                <div class="profile_data">
                    <div class="profile_line">
                        ...
                        <div class="value_field">
                            <input type="password" name="oldPassword" class="valid"
                    ...
                    <div class="profile_line">
                        ...
                        <div class="value_field">
                            <input type="password" name="newPassword" class="valid"
                                   placeholder="&middot;&middot;&middot;&middot;&middot;&middot;&middot;&middot;">
                        </div>
                    </div>
                    <div class="profile_line">
                        ...
                        <div class="value_field">
                            <input type="password" name="verifyPassword" class="valid"
                                   placeholder="&middot;&middot;&middot;&middot;&middot;&middot;&middot;&middot;">
                        </div>
                    </div>
